...
SKIN.PrintName		= "Wildfire Black Mesa RP"
SKIN.Author		= "KiwifruitDev"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/bmrp2.png" )
...
derma.DefineSkin( "BMRP", "Wildfire Servers' Black Mesa RP Derma Skin", SKIN )