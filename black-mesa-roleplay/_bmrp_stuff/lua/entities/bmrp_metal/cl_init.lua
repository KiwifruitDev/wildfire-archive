...
function ENT:Draw()
    ...
    local text = "Scrap"
    local text2 = self:GetCraftingMaterialType() //"Resonance: " .. (self:GetCrystalScanned() and self:GetCrystalResonance() or "??") .. "%"
    ...
    cam.Start3D2D(pos, ang, 0.05)
        ...
        draw.SimpleText(text, "CraftingTableText", 4, -4, Color(0,0,0), 1, 1)
        draw.SimpleText(text2, "CraftingTableText", 4, 89, Color(0,0,0), 1, 1)
        draw.SimpleText(text, "CraftingTableText", 0, -8, Color(255,255,255), 1, 1)
