...
local VElementsMel = {
	["BodyLight"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "pgun_root", rel = "", pos = Vector(6, -3.6, 0), size = { x = 0.018, y = 0.018 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BodyLight1"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "pgun_root", rel = "", pos = Vector(6, -3.6, 0), size = { x = 0.018, y = 0.018 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BodyLight2"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "pgun_root", rel = "", pos = Vector(6, -3.6, 0), size = { x = 0.018, y = 0.018 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BodyLight3"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "pgun_root", rel = "", pos = Vector(6, -3.6, 0), size = { x = 0.018, y = 0.018 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BodyLight4"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "pgun_root", rel = "", pos = Vector(6, -3.6, 0), size = { x = 0.018, y = 0.018 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BodyLight4"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "pgun_root", rel = "", pos = Vector(6, -3.6, 0), size = { x = 0.018, y = 0.018 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BodyLight5"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "pgun_root", rel = "", pos = Vector(6, -3.6, 0), size = { x = 0.018, y = 0.018 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BeamPoint1"] = { type = "Sprite", sprite = "sprites/portalgun_effects", bone = "nozzle", rel = "", pos = Vector(-0, -0, -0), size = { x = 0.04, y = 0.04 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BeamPoint2"] = { type = "Sprite", sprite = "sprites/portalgun_effects", bone = "nozzle", rel = "", pos = Vector(-0.5, -0, -0), size = { x = 0.04, y = 0.04 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BeamPoint3"] = { type = "Sprite", sprite = "sprites/portalgun_effects", bone = "nozzle", rel = "", pos = Vector(-0.8, -0, -0), size = { x = 0.04, y = 0.04 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BeamPoint4"] = { type = "Sprite", sprite = "sprites/portalgun_effects", bone = "nozzle", rel = "", pos = Vector(-1, -0, -0), size = { x = 0.04, y = 0.04 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["BeamPoint5"] = { type = "Sprite", sprite = "sprites/portalgun_effects", bone = "nozzle", rel = "", pos = Vector(-1.5, -0, -0), size = { x = 0.04, y = 0.04 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["InsideEffects"] = { type = "Sprite", sprite = "sprites/portalgun_effects", bone = "nozzle", rel = "", pos = Vector(0.7, -0, 0), size = { x = 0.04, y = 0.04 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false}
}
...
local WElementsMel = {
	["BodyLight"] = { type = "Sprite", sprite = "sprites/portalgun_light", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.5, 1 , -4.5), size = { x = 0.03, y = 0.03 }, color = Color(255, 255, 255, 255), nocull = false, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false}
}
...
function SWEP:Initialize()
	...
	self.VElementsMel = table.FullCopy( VElementsMel )
	self.WElementsMel = table.FullCopy( WElementsMel )
...
local GravitySpritesMel = {
	{bone = "clavicle_left_3", pos = Vector(-1.25 ,-0.10, 1.06), size = { x = 0.02, y = 0.02 }},
	{bone = "clavicle_top_3", pos = Vector(0.10, 1.25, 1.00), size = { x = 0.02, y = 0.02 }},
	{bone = "clavicle_right_3", pos = Vector(0.10, 1.25, 1.05), size = { x = 0.02, y = 0.02 }}
}
function SWEP:DrawPickupEffects(ent)
	
	//Draw the lights
	local lightOrigins = {}
	local tblsprites = GravitySprites
	if self.IsMelPortalGun then
		tblsprites = GravitySpritesMel
	end
	for k,v in pairs(tblsprites) do
...
local VGravitySpritesMel = {
	{bone = "clavicle_left_1", pos = Vector(0, 0, 0), size = { x = 0.018, y = 0.018 }},
	{bone = "clavicle_top_1", pos = Vector(0, 0, 0), size = { x = 0.018, y = 0.018 }},
	{bone = "clavicle_right_1", pos = Vector(0, 0, 0.30), size = { x = 0.018, y = 0.018 }},
	{bone = "clavicle_left_2", pos = Vector(0, 0, 0), size = { x = 0.018, y = 0.018 }},
	{bone = "clavicle_top_2", pos = Vector(0, 0.20, -0.10), size = { x = 0.018, y = 0.018 }},
	{bone = "clavicle_right_2", pos = Vector(-0.10, 0.30, -0.10), size = { x = 0.018, y = 0.018 }},	
}
...
function SWEP:ViewModelDrawn(vm)
	...
	//Draw the lights
	local lightOrigins = {}
	local tblsprites = VGravitySprites
	if self.IsMelPortalGun then
		tblsprites = VGravitySpritesMel
	end
	for k,v in pairs(tblsprites) do
	...
	local tbl = self.VElements
	if self.IsMelPortalGun then
		tbl = self.VElementsMel
	end
	...
	for k, name in pairs(tbl) do
		...
		local pos, ang = self:GetBoneOrientation(tbl, v, vm)
		...
		if (v.type == "Sprite" and sprite) then
			...
			-- WILDFIRE CHANGE --
			if self:GetNWInt("portalFlipper",1) > 2 then
				col = OrderedPortalGunColors[self:GetNWInt("lastPortalFlipper",1)]
...
function SWEP:DrawWorldModel()
	...
	local tbl = self.WElements
	if self.IsMelPortalGun then
		tbl = self.WElementsMel
	end
	...
	for k, name in pairs( self.wRenderOrder ) do
		...
		if (v.bone) then
			pos, ang = self:GetBoneOrientation( tbl, v, bone_ent )
		else
			pos, ang = self:GetBoneOrientation( tbl, v, bone_ent, "ValveBiped.Bip01_R_Hand" )
		end
...
local drawmaterial
	...
	-- WILEFIRE CHANGE --
	local portalFlipper = self:GetNWInt("portalflipper",1)
	if portalFlipper > 2 then
		surface.SetDrawColor(OrderedPortalGunColors[portalFlipper])
	else
	...
	-- WILEFIRE CHANGE --
	if portalFlipper > 2 then
		surface.SetDrawColor(OrderedPortalGunColors[LinkedPortalEnums[portalFlipper]])
	else
