...
if CLIENT then
	...
	language.Add("tool.aperture_floor_button.desc", "Place something on the button to send a signal.")
	language.Add("tool.aperture_floor_button.enable", "Key to activate (unused)")
	language.Add("tool.aperture_floor_button.0", "LMB: Place")
end
