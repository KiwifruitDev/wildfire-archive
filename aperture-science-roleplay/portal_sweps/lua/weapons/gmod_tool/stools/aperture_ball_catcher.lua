...
if CLIENT then
	...
	language.Add("tool.aperture_ball_catcher.desc", "Catches high energy pellets and sends a signal")
	language.Add("tool.aperture_ball_catcher.0", "LMB: Place")
	language.Add("tool.aperture_ball_catcher.enable", "Key to activate (unused)")
end
