...
if CLIENT then
	language.Add("tool.aperture_tractor_beam.name", "Excursion funnel")
	language.Add("tool.aperture_tractor_beam.desc", "A funnel that moves objects that are inside it.")
	language.Add("tool.aperture_tractor_beam.0", "LMB: Place")
	language.Add("tool.aperture_tractor_beam.enable", "Enable")
	language.Add("tool.aperture_tractor_beam.reverse", "Reverse")
	language.Add("tool.aperture_tractor_beam.startenabled", "Start active")
	language.Add("tool.aperture_tractor_beam.startenabled.help", "Excursion funnel starts enabled when placed.")
	language.Add("tool.aperture_tractor_beam.startreversed", "Start reversed")
	language.Add("tool.aperture_tractor_beam.startreversed.help", "Moves objects towards itself when placed.")
