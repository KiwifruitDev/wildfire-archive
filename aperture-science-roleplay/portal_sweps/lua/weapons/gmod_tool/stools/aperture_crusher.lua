...
if CLIENT then
	...
	language.Add("tool.aperture_crusher.desc", "Place it, crush it. It destroys anything...")
	language.Add("tool.aperture_crusher.0", "LMB: Place")
	language.Add("tool.aperture_crusher.enable", "Enable (unused)")
	language.Add("tool.aperture_crusher.startenabled", "Start active")
	language.Add("tool.aperture_crusher.startenabled.help", "Crusher will start active after placed.")
	language.Add("tool.aperture_crusher.twoside", "Double-sided")
	language.Add("tool.aperture_crusher.twoside.help", "The crusher will have two sides rather than one.")
	language.Add("tool.aperture_crusher.countx", "Number of panels X")
	language.Add("tool.aperture_crusher.county", "Number of panels Y")
	language.Add("tool.aperture_crusher.toggle", "Toggle (unused)")
end
