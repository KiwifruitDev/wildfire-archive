...
if CLIENT then
	language.Add("tool.aperture_laser_field.name", "Laser field")
	language.Add("tool.aperture_laser_field.desc", "Prevents living and non-living objects from leaving the test chamber.")
	language.Add("tool.aperture_laser_field.0", "LMB: Place")
	language.Add("tool.aperture_laser_field.enable", "Enable")
	language.Add("tool.aperture_laser_field.startenabled", "Start active")
	language.Add("tool.aperture_laser_field.startenabled.help", "Field will start active once placed.")
