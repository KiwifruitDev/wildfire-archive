...
if CLIENT then
	...
	language.Add("tool.aperture_wall_projector.desc", "Acts as a hard bridge for the player, shield against turrets, or even a wall.")
	language.Add("tool.aperture_wall_projector.0", "LMB: Place")
	language.Add("tool.aperture_wall_projector.enable", "Enable")
	language.Add("tool.aperture_wall_projector.startenabled", "Start active")
	language.Add("tool.aperture_wall_projector.startenabled.help", "Bridge will start active after being placed.")
