...
if CLIENT then
	language.Add("tool.aperture_item_dropper.name", "Dropper")
	language.Add("tool.aperture_item_dropper.desc", "Produces various cubes/entities.")
	language.Add("tool.aperture_item_dropper.0", "LMB: Place")
	language.Add("tool.aperture_item_dropper.keyenable", "Drop Button (unused)")
	language.Add("tool.aperture_item_dropper.dropType", "Cube/ball type")
	language.Add("tool.aperture_item_dropper.drop_at_start", "Activated from the start")
	language.Add("tool.aperture_item_dropper.drop_at_start.help", "Cube/ball will drop after the dropper is placed.")
	language.Add("tool.aperture_item_dropper.respawn", "Respawns")
	language.Add("tool.aperture_item_dropper.respawn.help", "Cube/ball respawns after being destroyed")
end
...
function TOOL:LeftClick(trace)
	...
	if math.Round(normal.z) != -1 or trace.Entity.IsAperture then
		ply:PrintMessage(HUD_PRINTCENTER, "The dropper can only be installed on the ceiling.")
		return
	end
