...
if CLIENT then
	language.Add("tool.aperture_laser_emitter.name", "Laser Emitter")
	language.Add("tool.aperture_laser_emitter.desc", "Emits a laser beam.")
	language.Add("tool.aperture_laser_emitter.0", "Emits a laser beam.")
	language.Add("tool.aperture_laser_emitter.enable", "Enable (unused)")
	language.Add("tool.aperture_laser_emitter.startenabled", "Start active")
	language.Add("tool.aperture_laser_emitter.startenabled.help", "The laser beam will be emitted once placed.")
	language.Add("tool.aperture_laser_emitter.toggle", "Toggle (unused)")
end
