...
if CLIENT then
	language.Add("tool.aperture_arm_panel.name", "Unstationary Scaffold")
	language.Add("tool.aperture_arm_panel.desc", "A moving floor panel")
	language.Add("tool.aperture_arm_panel.0", "LMB: Place panel")
	language.Add("tool.aperture_arm_panel.enable", "Enable")
	language.Add("tool.aperture_arm_panel.startenabled", "Starts active?")
	language.Add("tool.aperture_arm_panel.startenabled.help", "Panel will start active after placed.")
	language.Add("tool.aperture_arm_panel.localx", "Horizontal offset")
	language.Add("tool.aperture_arm_panel.localz", "Vertical offset")
	language.Add("tool.aperture_arm_panel.countx", "Number of panels X")
	language.Add("tool.aperture_arm_panel.county", "Number of panels Y")
	language.Add("tool.aperture_arm_panel.lpitch", "Pitch")
	language.Add("tool.aperture_arm_panel.toggle", "Sticky (disabled)")
end
