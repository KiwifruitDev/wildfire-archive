...
if CLIENT then
 	language.Add("tool.aperture_portal_frame.name", "Portal (Disabled)")
	language.Add("tool.aperture_portal_frame.desc", "Creates a portal within a frame.")
	language.Add("tool.aperture_portal_frame.0", "LMB: Place")
	language.Add("tool.aperture_portal_frame.enable", "Enable")
	language.Add("tool.aperture_portal_frame.startenabled", "Start active")
	language.Add("tool.aperture_portal_frame.startenabled.help", "The portal will open immediately after placing the frame.")
	language.Add("tool.aperture_portal_frame.toggle", "Toggle")
	language.Add("tool.aperture_portal_frame_model.portaltype", "Portal color")
end
