...
if CLIENT then
	...
	language.Add("tool.aperture_button.desc", "Press the button to send a signal.")
	language.Add("tool.aperture_button.enable", "Key to activate (unused)")
	language.Add("tool.aperture_button.timer", "Button hold time")
	language.Add("tool.aperture_button.0", "LMB: Place")
end
...
function TOOL.BuildCPanel( CPanel )
	...
	CPanel:NumSlider("#tool.aperture_button.timer", "aperture_button_timer", 0, 60)
end
