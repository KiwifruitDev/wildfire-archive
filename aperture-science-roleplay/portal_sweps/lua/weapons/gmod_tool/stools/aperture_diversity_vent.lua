...
if CLIENT then
	...
	language.Add("tool.aperture_diversity_vent.desc", "Send various products to a different location.")
	language.Add("tool.aperture_diversity_vent.0", "LMB: Place - RMB: Rotate")
	language.Add("tool.aperture_diversity_vent.count", "Quantity")
	language.Add("tool.aperture_diversity_vent.ignorealive", "Ignore players/NPCs")
	language.Add("tool.aperture_diversity_vent.ignorealive.help", "Players and NPCs will not be affected.")
	language.Add("tool.aperture_diversity_vent.keyenable", "Enable (unused)")
	language.Add("tool.aperture_diversity_vent.startenabled", "Start active")
	language.Add("tool.aperture_diversity_vent.startenabled.help", "Vent will start active after placed.")
	language.Add("tool.aperture_diversity_vent.toggle", "Toggle (unused)")
end
