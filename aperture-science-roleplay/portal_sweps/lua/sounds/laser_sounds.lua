...
local laserCatcherAmb =
{
	channel	= CHAN_BODY,
	name	= "TA:LaserCatcherAmb",
	level	= 75,
	sound	= {"laser/sp_a2_dual_lasers_l2.wav"
	, "laser/sp_a2_laser_intro_l1.wav"
	, "laser/sp_a2_laser_relays_l2_01.wav"
	},
	volume	= 0.7,
	pitch	= 100,
}
sound.Add(laserCatcherAmb)
