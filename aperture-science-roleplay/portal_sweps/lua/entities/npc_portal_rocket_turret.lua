...
ENT.PrintName 		= "Ракетная туррель"
...
if SERVER then
	...
	function ENT:RotateTurret(angle, speed)
		...
		local pitch = turretAngles.pitch - math.AngleDifference(turretAngles.pitch, angle.pitch + 2) / 5 --speed
		local yaw = turretAngles.yaw - math.AngleDifference(turretAngles.yaw, angle.yaw - 90) / 5 --speed
