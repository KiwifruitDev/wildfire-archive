...
function ENT:OpenPortal(portalType)
	...
	local entToUse = owner:GetNWEntity( "Portal:Type1", nil )
	local otherEnt = owner:GetNWEntity( "Portal:Type2", nil )
	...
	if not IsValid(entToUse) then
		...
		// todo: wtf
		owner:SetNWEntity( "Portal:Type1", portal )
